      ...
      <div class="table-cont">
        <el-table ref="dataTable" :data="tableData" border stripe>
          ...
          <el-table-column
            ...
            show-overflow-tooltip
          ></el-table-column>
          <!-- <el-table-column label="关联" min-width="100">
            <template slot-scope="scope">
              <el-button type="primary" size="mini" @click="openLink(scope.row)"
                >关联设备</el-button
              >
            </template>
          </el-table-column> -->
...
export default {
  ...
  methods: {
    async getTableData() {
      ...
      this.loading = true;
      await api.resources.getFramePagingInfo(params).then((res) => {
        this.loading = false;
